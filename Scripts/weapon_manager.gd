...
@onready var weapon_icon = $CanvasLayer/WeaponInventory/VBoxContainer/Control/TextureRect
...
func update_weapon_ui():
	...
	if weapon_icon and current_name in weapon_icons:
		weapon_icon.texture=weapon_icons[current_name]
